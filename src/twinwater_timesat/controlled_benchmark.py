...
def canonical_mask_identity(
    ...
    *,
    ...
    """Compare canonical generated bytes directly with the frozen raw file."""

    regenerated_sha256 = hashlib.sha256(
        deterministic_csv_bytes(regenerated)
    ).hexdigest()
    ...
    return {
        ...
        "regenerated_canonical_sha256": regenerated_sha256,
        "frozen_raw_file_sha256": frozen_sha256,
        "phase3_preperformance_manifest_sha256": phase3_manifest_sha256,
        "controlled_benchmark_manifest_sha256": controlled_manifest_sha256,
    }
...
def audit_controlled_family(
    *, repository_root: str | Path, family: str
    ...
    frozen_mask_path = root / "results/phase3/preflight" / FAMILIES[family]
    masks = pd.read_csv(frozen_mask_path)
    phase3_preflight = json.loads(
        (
            root / "results/phase3/preflight/erken_phase3_preperformance_gate.json"
        ).read_text()
    )
    config = load_event_protocol_config(root)
    ...
    phase3_manifest_mask_sha256 = phase3_preflight["table_sha256"][
        FAMILIES[family]
    ]
    mask_identity = canonical_mask_identity(
        regenerated_masks,
        frozen_path=frozen_mask_path,
        phase3_manifest_sha256=phase3_manifest_mask_sha256,
        controlled_manifest_sha256=manifest["mask_manifest_sha256"],
    )
    ...
    checks = {
        ...
        "deterministic_masks": mask_identity["passed"],
    ...
    audit: dict[str, Any] = {
        ...
        "deterministic_mask_identity": mask_identity,
